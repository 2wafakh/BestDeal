...
import edu.esprit.dao.AdminFBDAO;
...
public class ConnexionFacebook {
    ...
    public static AdminFB currentUser;
    // les attribus 
    public static String API_KEY = "258375444330232";
    public static String SECRET = "f289051bf3cd6fdb2ede8bf3a9d19f8a";
                               ...
                               public void handleText(char[] data, int pos) {
                                   try {
                                     ...
                                     String userId= user.getUsername();
                                       ...
                                       AdminFBDAO admin = new AdminFBDAO();
                                   String useradminid= admin.findadminByid(userId).getFbpseudo();
                                    if(useradminid.equals(userId))
                                    {
                                           acceuil index = new acceuil();
